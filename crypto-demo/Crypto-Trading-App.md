...
FROM UsdCryptoTraderTickerResponseStream[context:getVar('region') == 'coxedge-las'] WINDOW SLIDING_LENGTH(10);
...
SELECT "Bitstamp" as exchange, "Europe" as quote_region,
        ...
        time:timestampInMilliseconds()/1000 as timestamp
FROM EurCryptoTraderTickerResponseStream[context:getVar('region') == 'coxedge-las'] WINDOW SLIDING_LENGTH(10);
...
SELECT "Bitflyer" as exchange, "Asia-Pacific" as quote_region,
        ...
        time:timestampInMilliseconds()/1000 as timestamp
FROM JpyCryptoTraderTickerResponseStream[context:getVar('region') == 'coxedge-las'] WINDOW SLIDING_LENGTH(10);
